...
var Node, TreeLayout, TreeNode, computeHeight, create_layer_node, defaultSeparation, diag_v, executeShifts, frame, getCurrentCanvas, hierarchy, moveSubtree, nextAncestor, nextLeft, nextRight, rect, ref, resizeHandler, resizeTimer, root, text_svg, textbox, treeRoot, tree_data, tree_layout, userAgent, vm;
...
vm = {
  ...
  create: function() {
    ...
    return vm.frame(frame(node_list, w, h));
  }
};
